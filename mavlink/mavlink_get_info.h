...
*/
static inline const mavlink_message_info_t *mavlink_get_message_info_by_id(uint32_t msgid)
{
...
/*
  return the message_info struct for a message
*/
static inline const mavlink_message_info_t *mavlink_get_message_info(const mavlink_message_t *msg)
{
...
/*
  return the message_info struct for a message
*/
static inline const mavlink_message_info_t *mavlink_get_message_info_by_name(const char *name)
{
